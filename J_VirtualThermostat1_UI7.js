//# sourceURL=J_VirtualThermostat1_UI7.js
/** 
 * J_VirtualThermostat1_UI7.js
 * Configuration interface for Virtual Thermostat
 *
 * Copyright 2016,2017 Patrick H. Rigney, All Rights Reserved.
 * This file is part of the  Virtual Thermostat Plugin for Vera. 
 * For license information, see LICENSE at https://github.com/toggledbits/vt/
 * $Id: $
 */
 
// "use strict"; // fails under UI7, fine on ALTUI
var VirtualThermostat = (function(api) {

    // unique identifier for this plugin...
    var uuid = '32f7fe60-79f5-11e7-969f-74d4351650de';

    var serviceId = "urn:toggledbits-com:serviceId:VirtualThermostat1";
    ...
    function configurePlugin()
    {
        ...
        {
            console.log(e);
            Utils.logError('Error in VirtualThermostat.configurePlugin(): ' + e);
        }
    }
